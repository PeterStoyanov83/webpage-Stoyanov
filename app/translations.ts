...
const en: TranslationType = {
  ...
  story: {
    ...
    p2: 'Each Stoyanoff guitar is a testament to the countless hours I've spent perfecting my craft, the knowledge passed down from master luthiers, and my unwavering commitment to quality. Every instrument I create is not just a guitar, but a piece of art that carries a part of my story and passion.'
  },
  services: {
    title: 'My Services',
    custom: {
