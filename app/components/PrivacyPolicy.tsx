export default function PrivacyPolicy() {
    return (
        <div className="container invert mx-auto px-20 py-16 pt-32">
            <h1 className="text-3xl font-bold mb-8">Privacy Policy</h1>
            <p className="mb-4">Last updated: [Current Date]</p>
            <p className="mb-4">Stoyanov Guitars ("we", "us", or "our") operates the website
                https://www.stoyanovguitars.com (the "Service"). This page informs you of our policies regarding the
            ...
            <p className="mb-4">We collect several different types of information for various purposes to provide and
            ...
            <p className="mb-4">While using our Service, we may ask you to provide us with certain personally
            ...
            <p className="mb-4">We may also collect information on how the Service is accessed and used ("Usage Data").
            ...
            <p className="mb-4">Stoyanov Guitars uses the collected data for various purposes:</p>
            <ul className="list-disc list-inside mb-4">
            ...
            <p className="mb-4">We may update our Privacy Policy from time to time. We will notify you of any changes by
                posting the new Privacy Policy on this page.</p>
            <p className="mb-4">We will let you know via email and/or a prominent notice on our Service, prior to the
                change becoming effective and update the "effective date" at the top of this Privacy Policy.</p>
            <p className="mb-4">You are advised to review this Privacy Policy periodically for any changes. Changes to
                this Privacy Policy are effective when they are posted on this page.</p>

            <h2 className="text-2xl font-semibold mt-8 mb-4">Contact Us</h2>
            <p className="mb-4">If you have any questions about this Privacy Policy, please contact us:</p>
            <ul className="list-disc list-inside mb-4">
                <li>By email: info@stoyanovguitars.com</li>
                <li>By visiting this page on our website: https://www.stoyanovguitars.com/contact</li>
            </ul>
        </div>
    )
}
