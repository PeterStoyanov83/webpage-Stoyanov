...
const bg: TranslationType = {
    ...
    guitars_data: {
        ...
        hellcaster: {
            ...
            description: 'Хелкастър е уникална смесица от класически дизайн и тъмна естетика. Тази персонализирана китара разполага с изострена черна обработка, която разкрива естествената дървесна текстура отдолу, създавайки впечатляващ изгорен ефект. Контрастът между тъмното тяло и мраморния бял пикгард създава драматично визуално изявление. Изработена за музиканти, които търсят както отличителен външен вид, така и превъзходна пригодност за свирене.'
        },
        palemoon: {
            name: 'Пейлмуун',
        ...
        'modern-t': {
            ...
            description: 'Модерн Т взема легендарната форма и я зарежда със съвременни характеристики. Предлага удобен контур на тялото, мощни звукоснематели и съвременен С-образен профил на грифа. Модерн Т е перфектен за музиканти, които ценят класическата естетика, но изискват съвременни изпълнителски възможности.'
        },
        wednesday: {
            name: 'Уенсдей',
        ...
        'fretless-bass': {
            name: 'Безпрагов Бас',
            shortDescription: 'Моя идея, все още в разработка.',
            description: 'В момента в разработка, този персонализиран безпрагов бас представлява нашето навлизане в света на бас инструментите. Вдъхновен от Marleaux Diva и с красив Koa топ от швейцарски производител на китари, този бас е проектиран да бъде универсален 3 в 1 инструмент. Той комбинира електрически, акустични и синтезаторни възможности, предлагайки на музикантите невероятно широк спектър от тонални възможности. Безпраговият дизайн обещава да достави гладките, пеещи качества, които само безпраговият бас може да предложи, докато многото системи за озвучаване осигуряват несравнима универсалност.'
        }
    },
    privacyPolicy: {
